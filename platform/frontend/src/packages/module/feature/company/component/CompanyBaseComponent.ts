...
import { Company, COMPANY_PREFERENCES_ADDRESS_MAX_LENGTH, COMPANY_PREFERENCES_EMAIL_MAX_LENGTH, COMPANY_PREFERENCES_INN_MAX_LENGTH, COMPANY_PREFERENCES_INN_MIN_LENGTH, COMPANY_PREFERENCES_CITY_MAX_LENGTH, COMPANY_PREFERENCES_PHONE_MAX_LENGTH, COMPANY_PREFERENCES_STRING_MAX_LENGTH, COMPANY_PREFERENCES_TITLE_MAX_LENGTH, COMPANY_PREFERENCES_TITLE_MIN_LENGTH, COMPANY_PREFERENCES_WEBSITE_MAX_LENGTH } from "@project/common/platform/company";
...
export abstract class CompanyBaseComponent extends IWindowContent {
    ...
    public get cityMaxLength(): number {
        return COMPANY_PREFERENCES_CITY_MAX_LENGTH;
    }
